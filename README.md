...
- GUIの `ZIPパスコピー` では、送付前チェックと購入者向けZIP検証を通過したZIPの絶対パスだけをクリップボードへコピーできます。GUIの `送付情報コピー` では、ZIP名、絶対パス、サイズ、SHA-256、送付文ファイルを1枚の照合値としてコピーできます。販売ページや注文管理画面へ添付する前に、`送付文コピー` と並べて使うことで誤添付を減らせます。
