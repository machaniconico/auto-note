...
- `ホーム`: 今日の状態、初回/記事/仕上げ/投稿/販売/サポートを横断する作業進行、初回セットアップのスコアと次項目、優先アクション一覧、購入者送付ファイルまで開ける直近レポート、販売者情報の次項目と動的ボタン、生成物不足/NG件数/更新状態、配布ZIP/販売素材/掲載キット/販売一式/掲載画像の有無/NG、購入者ZIP/送付文/送付記録/最新配布ZIP一致、納品照合、送付証跡と最新の販売前一括チェックまで見える販売準備サマリー、10工程の販売準備タイムライン、スターター一式、運用サマリー、操作検索つきの次の作業、公開予定の概要
