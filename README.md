...
- `診断`: 初回チェック、受入チェック、販売準備、販売用一式、運用サマリー、環境チェック、復旧セット、自動修復、トラブル診断、出荷前チェック、出荷ZIP作成、ログ表示、GUIログ場所、バックアップ、診断レポート、診断ZIP場所、診断ZIPパス、配布ZIP作成
- `ヘルプ`: README、サポート文書、プライバシー文書、アプリ情報、初回チェック、受入チェック、販売準備、問い合わせテンプレート、診断レポート、診断ZIP場所、診断ZIPパス、出荷ZIP、配布ZIP、保守フォルダへの導線
