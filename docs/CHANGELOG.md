...
- ホームの `販売前一括チェック` で24時間を超えたOK結果を `CHECK` として表示し、販売直前の総点検を再実行する判断を促す鮮度警告
- ホームの `販売準備タイムライン` で、販売者情報、配布ZIP、販売素材、掲載キット、販売一式、購入者ZIP/送付文、送付前照合、販売直前、販売前一括チェックの9工程をOK/CHECK/NGで確認し、各工程を直接開ける導線
