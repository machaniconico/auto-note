...
- `scripts\check-release.ps1` で、構文チェック、全unittest、製品品質ゲート、VBSランチャー構文チェック、GUI smoke、GUI safe display smokeを一括確認でき、`-Full` でプライバシー監査、販売準備、preflight、インストール/アンインストールスモーク、販売一括/購入者送付/販売直前チェック保存スモークまで広げられる
