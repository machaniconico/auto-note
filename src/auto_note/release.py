...
def _build_start_here() -> str:
    return (
        ...
        "4. 文字や行高が潰れて見える場合は auto-note safe display を開きます。\n"
        ...
        "- GUIは開くが文字が読みにくい場合は auto-note safe display または auto-note-gui.bat --safe-display を使います。\n"
        "\n"
        "配布内容の確認:\n"
...
def _build_first_run_checklist() -> str:
    return (
        ...
        "[ ] 3. 文字や行高が潰れる場合は auto-note safe display で開けた\n"
        ...
        "- 文字や行高が潰れて見える場合は auto-note safe display または auto-note-gui.bat --safe-display で開きます。\n"
...
def _build_buyer_acceptance_checklist() -> str:
    return (
        ...
        "[ ] 7. GUIの ログイン安全ガイド を確認し、普段使うブラウザでnote.comにログインできた\n"
        "[ ] 8. バックアップ作成を実行できた\n"
...
def _build_release_summary(project_dir: Path, created_at: datetime) -> str:
    ...
    return (
        ...
        "- auto-note safe display if text looks cramped after installing\n"
