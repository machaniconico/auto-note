...
def run_quality_checks(project_dir: Path, *, include_articles: bool = True) -> list[QualityCheck]:
    ...
    checks.append(
        _text_contains_check(
            project_dir / "README.md",
            "README home operation panel guidance",
            "今日のオペレーション",
        )
    )
    checks.append(
    ...
    checks.append(
        _text_contains_check(
            ...
            "troubleshoot privacy first NG detail",
            "first NG:",
        )
    )
    checks.append(
    ...
    checks.append(
        _text_contains_check(
            project_dir / "src" / "auto_note" / "sales_finalize.py",
            "sales finalize creates sales screenshots",
            "create_sales_screenshot_pack",
        )
    )
    checks.append(
        _text_contains_check(
            project_dir / "src" / "auto_note" / "sales_finalize.py",
            "sales finalize verifies sales screenshots",
    ...
    checks.append(
        _text_contains_check(
            project_dir / "src" / "auto_note" / "sales_finalize.py",
            "sales finalize details sales screenshots",
    ...
    checks.append(
        _text_contains_check(
            project_dir / "src" / "auto_note" / "__main__.py",
            "CLI sales review report command",
    ...
    checks.append(
        _text_contains_check(
            project_dir / "src" / "auto_note" / "sales_review.py",
            "sales review buyer send readiness",
            "run_buyer_send_readiness",
        )
    )
    checks.append(
    ...
    checks.append(
        _text_contains_check(
            project_dir / "src" / "auto_note" / "sales_finalize.py",
            "sales finalize artifacts sales screenshot pack",
    ...
    checks.append(
        _text_contains_check(
            project_dir / "src" / "auto_note" / "gui.py",
            "GUI smoke home release check summary",
    ...
    checks.append(
        _text_contains_check(
            project_dir / "src" / "auto_note" / "gui.py",
            "GUI smoke home release check status pill",
    ...
    checks.append(
        _text_contains_check(
            project_dir / "src" / "auto_note" / "gui.py",
            "GUI smoke home release check action button",
    ...
    checks.append(
        _text_contains_check(
            project_dir / "src" / "auto_note" / "gui.py",
            "GUI smoke display readability status",
    ...
    checks.append(
        _text_contains_check(
            project_dir / "src" / "auto_note" / "gui.py",
            "GUI smoke actual display font family",
    ...
    checks.append(
        _text_contains_check(
            project_dir / "src" / "auto_note" / "gui.py",
            "GUI modern home operation panel",
            "home_operation_vars",
        )
    )
    checks.append(
        _text_contains_check(
            project_dir / "src" / "auto_note" / "gui.py",
            "GUI modern home operation refresh",
    ...
    checks.append(
        _text_contains_check(
            project_dir / "src" / "auto_note" / "gui.py",
            "GUI modern home operation helper",
    ...
    checks.append(
        _text_contains_check(
            project_dir / "src" / "auto_note" / "gui.py",
            "GUI smoke home operation count",
    ...
    checks.append(
        _text_contains_check(
            project_dir / "src" / "auto_note" / "gui.py",
            "GUI home operation summary save action",
    ...
    checks.append(
        _text_contains_check(
            project_dir / "src" / "auto_note" / "gui.py",
            "GUI home operation summary saved report",
            "home-operation-",
        )
    )
    checks.append(
        _text_contains_check(
            project_dir / "src" / "auto_note" / "gui.py",
            "GUI home operation summary report list",
    ...
    checks.append(
        _text_contains_check(
            project_dir / "src" / "auto_note" / "gui.py",
            "GUI smoke home operation save action",
    ...
    checks.append(
        _text_contains_check(
            project_dir / "src" / "auto_note" / "gui.py",
            "GUI display readability checks",
    ...
    checks.append(
        _text_contains_check(
            project_dir / "src" / "auto_note" / "gui.py",
            "GUI display readability status line",
            "- status:",
        )
    )
    checks.append(
        _text_contains_check(
            project_dir / "src" / "auto_note" / "gui.py",
            "GUI display readability warning actions",
            "/ action:",
        )
    )
    checks.append(
    ...
    checks.append(
        _text_contains_check(
            project_dir / "src" / "auto_note" / "gui.py",
            "GUI home release check summary",
    ...
    checks.append(
        _text_contains_check(
            project_dir / "src" / "auto_note" / "gui.py",
            "GUI home release check status pill",
    ...
    checks.append(
        _text_contains_check(
            project_dir / "src" / "auto_note" / "gui.py",
            "GUI home release check dynamic action",
    ...
    checks.append(
        _text_contains_check(
            project_dir / "src" / "auto_note" / "gui.py",
            "GUI home release check latest result action",
    ...
    checks.append(
        _text_contains_check(
            project_dir / "src" / "auto_note" / "gui.py",
            "GUI home sales screenshot summary",
    ...
    checks.append(
        _text_contains_check(
            project_dir / "src" / "auto_note" / "gui.py",
            "GUI home sales artifact summary",
    ...
    checks.append(
        _text_contains_check(
            project_dir / "src" / "auto_note" / "gui.py",
            "GUI home sales artifact NG guard",
            "artifact_ng_count",
        )
    )
    checks.append(
        _text_contains_check(
            project_dir / "src" / "auto_note" / "gui.py",
            "GUI home sales artifact freshness guard",
    ...
    checks.append(
        _text_contains_check(
            project_dir / "src" / "auto_note" / "gui.py",
            "GUI home sales freshness summary",
    ...
    checks.append(
        _text_contains_check(
            project_dir / "src" / "auto_note" / "gui.py",
            "GUI home buyer send package freshness",
    ...
    checks.append(
        _text_contains_check(
            project_dir / "src" / "auto_note" / "gui.py",
            "GUI buyer delivery ZIP path copy action",
    ...
    checks.append(
        _text_contains_check(
            project_dir / "src" / "auto_note" / "gui.py",
            "GUI buyer delivery ZIP path copy guard",
    ...
    checks.append(
        _text_contains_check(
            project_dir / "src" / "auto_note" / "gui.py",
            "GUI sales review report action",
    ...
    checks.append(
        _text_contains_check(
            project_dir / "docs" / "PRODUCT_READINESS.md",
            "product readiness sales review command",
            "sales-review",
        )
    )
    checks.append(
